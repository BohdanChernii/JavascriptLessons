...
sayName.apply({ name: student.name });
...
greeting.apply({ companyName: company.companyName }, ["Bob", "Marley"]);
...
const population = getPopulation.apply(
  { countryName: country.countryName, capital: country.capital },
  [43000]
);
...
func.apply(anotherTransaction,{amount: 400, currency: transaction.currency, operation: "buy", exchange: "NASDAQ",});
